...
(function () {
    var c = {actus:{get:function (b, a) {
        ...
        c.tools.executeAsyncRequestV2("GET", "http://www.pcinpact.com/rss/emplois.xml", "document", function (a) {
            for (var a = a.response.getElementsByTagName("item"), f = [], e = {}, d = 0; d < a.length; d++) {
                var c = {};
...
(function () {
    var c = {getBonsPlans:function (b) {
        PCi.tools.executeAsyncRequestV2("GET", "http://www.prixdunet.com/bon-plan.html?motcle=&type=0&order=nb_lectures&way=desc", "document", function (a) {
            for (var f = {}, e = [], d = a.response.getElementById("list_bp").getElementsByClassName("bp_table"), a = a.response.getElementById("list_bp").getElementsByClassName("bp_titre"), c = 0; c < a.length; c++)f = {titre:a[c].getElementsByTagName("a")[0].innerText, date:a[c].getElementsByTagName("span")[0].innerText, categorie:{img:d[c].getElementsByTagName("img")[0].src,
                url:d[c].getElementsByTagName("a")[0].href}, url:a[c].getElementsByTagName("a")[0].href}, e.push(f), f = {list:e, lastUpdateDate:(new Date).toString(), error:!1};
            b(f)
        })
    }};
